...
return (
    <div className='min-h-full max-w-7xl mx-auto w-full px-4 py-16 sm:px-6 lg:px-10'>
        ...
        <div className='flex justify-center items-center gap-10 flex-col'>
            ...
            <h1 className='text-4xl md:text-3xl font-semibold underline'>New arrivals</h1>
            ...
            <div className='grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 w-full gap-10'>
                ...
                return <Link key={elem.id} to={`/eachproduct/${elem.id}`} className='w-full flex flex-col items-start gap-5'>
                    <img className="h-[220px] md:h-[280px] cursor-pointer w-full object-cover rounded-2xl transition-transform hover:scale-102 hover:shadow-lg duration-300" src={elem.image} alt={elem.title} />
