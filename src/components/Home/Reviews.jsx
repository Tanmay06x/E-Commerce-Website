  ...
  return (
    <div className='min-h-full py-10 md:py-16'>
        ...
        <div className='h-full flex flex-col justify-center gap-10 items-center'>
            ...
            <h1 className='text-2xl sm:text-3xl md:text-4xl font-bold'>Our happy customers</h1>

            <div  id='review' className='flex px-8 lg:px-0 max-w-7xl mx-auto w-full overflow-x-auto gap-5'>

                {reviews.map((r,id)=>{
                    return  <div key={id} className='w-80 md:w-110 shrink-0 bg-[#FFFFFF] border border-gray-300 rounded-2xl flex flex-col gap-1 justify-center px-8 py-4 sm:py-10'>
